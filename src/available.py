...
if __name__ == "__main__":
    ...
    X = county_facts.iloc[:, [3, 4, 5, 6, 7, 8, 9, 10, 11, 18, 19, 22, 23, 24, 25, 27, 32, 33, 34, 36, 39, 51, 52, 53]].values
    Y = normalize_results(primary_resaults)
    X_predict = poland.iloc[:, [3, 4, 5, 6, 7, 8, 9, 10, 11, 18, 19, 22, 23, 24, 25, 27, 32, 33, 34, 36, 39, 51, 52, 53]].values
    ...
    # create NN
    model = Sequential()
    model.add(Dense(output_dim=19, init='uniform', activation='relu', input_dim=24))
